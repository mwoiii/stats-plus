...
namespace StatsMod
{
    public class PlayerStatsDatabase
    {
        ...
        public static readonly string[] customStats = ["shrinePurchases", "shrineWins", "orderHits", "timeStill", "timeStillUnsafe", "timeLowHealth", "fallDamage", "coinsSpent", "avenges", "timesLastStanding", "itemLead", "nonScrapPrinted", "chainableProcs"];
