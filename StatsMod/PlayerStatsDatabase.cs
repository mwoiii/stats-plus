...
namespace StatsMod
{
    public class PlayerStatsDatabase
    {
        ...
        // "isPlayerControlled", "isSprinting", "outOfDanger", "jumpPower", "maxJumpHeight", "shouldAim", "bestFitRadius", "spreadBloomAngle", "corePosition", "footPosition", "radius", "aimOrigin", "isBoss"
        ...
        public static readonly string[] charBodyStats = ["experience", "level", "maxHealth", "regen", "maxShield", "moveSpeed", "acceleration", "maxJumpCount", "damage", "attackSpeed", "crit", "armor", "critHeal", "multiKillCount", "isElite"];
