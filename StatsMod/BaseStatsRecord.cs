...
namespace StatsMod
{
    public class BaseStatsRecord : StatsRecord
    {
        ...
        public BaseStatsRecord(PlayerCharacterMasterController instance, string name) : base(instance, name) { }  // Calling the base (parent) constructor method, which calls GetStats()
