    ...
    public class GraphHandler : MonoBehaviour {
        ...
        private void ResizeGraph(On.RoR2.SettingsConVars.ResolutionConVar.orig_SetString orig, RoR2.ConVar.BaseConVar self, string newValue) {
            ...
            if (graph != null) {
                ...
                GS.GraphSize = new Vector2(0.5208f * width, 0.7037f * height);
        ...
        private void PrepareGraph() {
            ...
            graph.localPosition = graph.localPosition = new Vector2(0.1302f * Screen.width, 0.0212f * Screen.height);
            ...
            maskObj = graph.transform.Find("MaskObj").GetComponent<RectTransform>();
            backgroundRect = maskObj.transform.Find("Background").GetComponent<RectTransform>();
            backgroundImage = backgroundRect.GetComponent<Image>();
            graphContent = backgroundRect.transform.Find("GraphContent").GetComponent<RectTransform>();
            */
